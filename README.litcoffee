# footprints
a session history navigation tool
...
## example
	...
	module.exports =
		...
		"footprints":
			...
			"can have history items added to it": ->
				list = new Footprints()

				list.visit href: "#nowhere"
				list.length.should.equal 1
				
				list.visit href: "#somewhere"
				list.length.should.equal 2

			"only keeps one history item per href": ->
				list = new Footprints()
			...
			"orders items by visit recency": ->
				...
				for href in hrefs
					list.visit href: href

				list.length.should.equal 3
				list[0].href.should.equal "#somewhere"
				list[1].href.should.equal "#everywhere"
				list[2].href.should.equal "#nowhere"

			"keeps only latest metadata": ->
				list = new Footprints()

				list.visit href: "#somewhere", foo:"bar"
				list.length.should.equal 1
				list[0].foo.should.equal "bar"

				list.visit href: "#somewhere", baz:"quux"
				list.length.should.equal 1
				should.not.exist list[0].foo
				list[0].baz.should.equal "quux"
